...
Public Class Form_tbhAdmin
    ...
    Sub koneksi()
        MyDB = "data source=DESKTOP-UEGPFQ8F\SQLEXPRESS;initial catalog=DB_LAUNDRY;integrated security=true"
    ...
    Private Sub Form_tbhAdmin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        dtp_tgl_adm.CustomFormat = "yyyy-mm-dd"
